                ...
                <div className="py-12">
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <Link to={developerInfo.social.github} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:bg-blue-600 transition-colors p-2.5 bg-gray-800 rounded-full ">
                            ...
                            <Link to={developerInfo.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:bg-blue-600 transition-colors p-2.5 bg-gray-800 rounded-full">
